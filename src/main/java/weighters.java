...
public class weighters
{
    public static float rateIMGLegacy(Image image, MessageReceivedEvent e, File folder, JDA botBuilt, boolean outputImg)
    {
        ...
        BufferedImage reader = Bot.toBufferedImage(image);
        ...
        BufferedImage readerCopy = Bot.toBufferedImage(image);
            ...
            for (int x = 0; x<=reader.getWidth()-1;x+=1)
        {
            for (int y = 0; y<=reader.getHeight()-1;y+=1)
            {
                ...
                if(Bot.debug)
                {
                    Bot.textArea.append("Color:"+CollorAvg+"\n");
                    Bot.textArea.append("TotalDif:"+DifferenceInPxls+"\n");
                }
                //}
        ...
        //DifferenceInPxls=(1-(1/DifferenceInPxls))*10;
            if(Bot.debug) Bot.textArea.append("TotalRating:" + DifferenceInPxls + "\n");
